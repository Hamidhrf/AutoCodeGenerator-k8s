...
public class ReadRedisQueue implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            processStreamMessage(jedis.xreadGroup(groupName, consumer, params, bID));
    ...
    private void processStreamMessage(List<Map.Entry<String, List<StreamEntry>>> records) throws Exception{
